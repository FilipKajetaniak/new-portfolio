  ...
  return (
    <Article>
      <h2 className="about-me-header">
        Get to know me <Emoji>🤟</Emoji>
      </h2>
      <p>
        My name is Filip Kajetaniak. I'm a 23 years old self taught front-end
        dev. I design and build web apps with React, Vue and JavaScript.
        Currently{" "}
        <span
          className={
        ...
        >
          I'm looking for a Junior React Front-End developer position in Warsaw.
        </span>{" "}
